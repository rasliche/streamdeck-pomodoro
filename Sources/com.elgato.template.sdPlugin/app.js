...
function connected(jsn) {
    ...
    $SD.on('com.ericraslich.sdpomodoro.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('com.ericraslich.sdpomodoro.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('com.ericraslich.sdpomodoro.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('com.ericraslich.sdpomodoro.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('com.ericraslich.sdpomodoro.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('com.ericraslich.sdpomodoro.action.propertyInspectorDidDisappear', (jsonObj) => {
